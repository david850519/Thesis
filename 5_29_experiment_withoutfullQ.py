            ...
            if(Part_Q_suc==False):
                for j in range(0,5):
                    ...
                    for k in path_dict.keys():
                        ...
                        #sample_num = round(math.pow(len(path_dict[k]),1/3))
...
if __name__ == '__main__':
    ...
    for i in range(0,5):
        ...
        if(ILP_signal == False):
            ...
            Part_Q_res = Main_Q(Grid_size,Obs_ratio,Robot_num,Arr)
        #Q
        # try:
        #     makespan_Q = Q_res[0]
        #     time_Q = Q_res[1]
        ...
        print(makespan_partQ_sum)
        print(time_partQ_sum)

    Experiment_time = time.time() - Experiment_start
    mail(str(Experiment_time))

    filename = "test10000_G" + str(Grid_size) + "O" + str(Obs_ratio) + "R" + str(Robot_num)
